...
const accordion = [
  ...
  {id: 3, name: "Mobile Detailing Begins", text: "After you decide your detailing package, we will get to work.  <strong>Note: If you are scheduling an exterior clean, we will need access to a water source.</strong>"},
